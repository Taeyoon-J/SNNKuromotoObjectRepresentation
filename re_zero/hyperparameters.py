...
class ObjectRepresentationConfig:
    ...
    # Number of receiver oscillators processed at once in pairwise Kuramoto coupling.
    ...
    # is no RGB oscillator axis, so this has no effect unless num_oscillators is laid
    ...
    gamma_attraction_strength: float = 3.0
