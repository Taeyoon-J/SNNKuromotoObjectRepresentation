...
class ObjectRepresentationConfig:
    ...
    readout_update_interval: int = 15
    ...
    background_suppression_weight: float = 4.0
    object_coverage_weight: float = 6.0
    ...
    attraction_strength_schedule: str = "linear_decay"
    attraction_strength_end: float = 2.0
    ...
    fixed_alpha_value: float = 0.15
    # Extra scales for reducing top-down feedback magnitude.
    feedback_affinity_scale: float = 0.10
    feedback_alpha_scale: float = 0.10
    delay: int = 2
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--readout_update_interval", type=int, default=15)
    ...
    parser.add_argument("--background_suppression_weight", type=float, default=4.0)
    parser.add_argument("--object_coverage_weight", type=float, default=6.0)
    ...
    parser.add_argument("--coupling_chunk_size", type=int, default=16)
    parser.add_argument("--channel_wise_coupling", action=argparse.BooleanOptionalAction, default=False)
    parser.add_argument("--attraction_strength", type=float, default=10.0)
    parser.add_argument("--attraction_strength_schedule", type=str, default="linear_decay", choices=["constant", "linear_decay"])
    parser.add_argument("--attraction_strength_end", type=float, default=2.0)
    ...
    parser.add_argument("--fixed_alpha_value", type=float, default=0.15)
    parser.add_argument("--feedback_affinity_scale", type=float, default=0.10)
    parser.add_argument("--feedback_alpha_scale", type=float, default=0.10)
    ...
    parser.add_argument("--gamma_value_floor", type=float, default=0.05)
